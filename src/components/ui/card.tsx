...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => <div ref={ref} className={cn('bg-secondary  text-card-foreground rounded-lg shadow-sm', className)} {...props} />);
